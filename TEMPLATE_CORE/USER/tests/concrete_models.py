"""Minimal concrete subclasses of all 9 abstract models for testing.

This module demonstrates the intended extension pattern: subclass, set
``__tablename__``, add FK columns. No template files are modified.

These classes also serve as the reference implementation for agents.
"""
